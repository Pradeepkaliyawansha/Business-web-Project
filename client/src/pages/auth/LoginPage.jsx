    ...
    <div className="min-h-screen flex items-center justify-center px-4 relative">
      ...
      <div className="relative w-full max-w-md animate-scale-in">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="font-display font-bold text-2xl text-white mt-6 mb-1">Welcome back</h1>
        ...
        <div className="mt-4 p-4 bg-dark-800/50 border border-dark-600 rounded-xl text-center">
          <p className="text-xs text-gray-500">
            Demo admin: <span className="text-gray-400 font-mono">admin@dilos.com</span> / <span className="text-gray-400 font-mono">admin123</span>
          </p>
        </div>
      </div>
    </div>
